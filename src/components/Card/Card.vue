...
<Card title="Website dashboard" sectioned>
  <p>View a summary of your website performance.</p>
</Card>
```
...
export default defineComponent({
  components: { CardSection, CardHeader, Heading },
  ...
  props: {
    ...
    /** Auto wrap the content in a section. */
    sectioned: {
      type: Boolean,
      default: false,
    },
    ...
    actions: {
      type: Array as PropType<DisableableAction[]>,
      default: () => ([]),
    },
  },
